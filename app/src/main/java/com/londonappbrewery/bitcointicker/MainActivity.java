...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get the PriceTextView from the layout by its id
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.d("Bitcoin", " URL:" +BASE_URL+ parent.getItemAtPosition(position));
    ...
    private void updateUI(BitcoinModel bitcoinData) {
        mPriceTextView.setText(Integer.toString(bitcoinData.getbPrice()));
    }
